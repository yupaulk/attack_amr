...
### Insert ARG Relative Abundance (Resfinder)
...
a1_plot <- a1 + geom_label_repel(mapping = aes(label = alias), 
                                 data = a1$data, size = 4, box.padding = 0.5,
                                 segment.color = "#CECECE", family = "Palatino")

a1_plot + plot_annotation(title = "PCA, clr-transformed, for three hospitals on Resistomes", subtitle = "ARGs") & 
...
a2_plot <- a2 + geom_label_repel(mapping = aes(label = alias), 
                                 data = a2$data, size = 4, box.padding = 0.5,
                                 segment.color = "#CECECE", family = "Palatino")
...
a2_plot + plot_annotation(title = "PCA, clr-transformed, for three hospitals on Resistomes", subtitle = "ARGs") & 
  theme(plot.title = element_text(size = 25, family = "Palatino", face = "bold"),
        plot.subtitle = element_text(size = 22, family = "Palatino", hjust = 0.5))
...
b1_plot <- b1 + geom_label_repel(mapping = aes(label = alias), 
                                 data = b1$data, size = 4, box.padding = 0.5,
                                 segment.color = "#CECECE", family = "Palatino")

b1_plot + plot_annotation(title = "PCA, clr-transformed, for three hospitals on Resistomes", subtitle = "ARGs") & 
  theme(plot.title = element_text(size = 25, family = "Palatino", face = "bold"),
        plot.subtitle = element_text(size = 22, family = "Palatino", hjust = 0.5))
...
b2_plot <- b2 + geom_label_repel(mapping = aes(label = alias), 
                                 data = b2$data, size = 4, box.padding = 0.5,
                                 segment.color = "#CECECE", family = "Palatino")

# Add indication for month with different shapes
b2_plot <- b2_plot + geom_point(aes(shape = factor(month)), size = 5)  
# Define labels for month legend
month_labels <- c("May", "June", "July")
...
b2_plot + plot_annotation(title = "PCA, clr-transformed, for three hospitals on Taxonomic Composition", subtitle = "Metaphlan") & 
  theme(plot.title = element_text(size = 25, family = "Palatino", face = "bold"),
        plot.subtitle = element_text(size = 22, family = "Palatino", hjust = 0.5))
...
c1_plot <- c1 + geom_label_repel(mapping = aes(label = alias), 
                                 data = c1$data, size = 4, box.padding = 0.5,
                                 segment.color = "#CECECE", family = "Palatino")

c1_plot + plot_annotation(title = "PCA, clr-transformed, for three hospitals on Resistomes", subtitle = "ARGs") & 
  theme(plot.title = element_text(size = 25, family = "Palatino", face = "bold"),
        plot.subtitle = element_text(size = 22, family = "Palatino", hjust = 0.5))
...
c2_plot <- c2 + geom_label_repel(mapping = aes(label = alias), 
                                 data = c2$data, size = 4, box.padding = 0.5,
                                 segment.color = "#CECECE", family = "Palatino")

# Add indication for month with different shapes
c2_plot <- c2_plot + geom_point(aes(shape = factor(month)), size = 5)  
# Define labels for month legend
month_labels <- c("May", "June", "July")
...
c2_plot + plot_annotation(title = "PCA, clr-transformed, for three hospitals on Mobilomes", subtitle = "MGEs") & 
  theme(plot.title = element_text(size = 25, family = "Palatino", face = "bold"),
        plot.subtitle = element_text(size = 22, family = "Palatino", hjust = 0.5))
