...
eda <- do.call(data.frame, aggregate(shannon ~ hospital, shannon_div, function(x) c(mean = mean(x), sd = sd(x))))
...
# Get mean and standard deviation
eda <- do.call(data.frame, aggregate(simpson ~ hospital, simpson_div, function(x) c(mean = mean(x), sd = sd(x))))
...
# Get mean and standard deviation
eda <- do.call(data.frame, aggregate(invsimpson ~ hospital, invsimp_div, function(x) c(mean = mean(x), sd = sd(x))))
...
# Get mean and standard deviation
eda <- do.call(data.frame, aggregate(richness ~ hospital, rich, function(x) c(mean = mean(x), sd = sd(x))))
...
# Plot
p <- ggboxplot(rich, x = "hospital", y = "richness", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#FEF250")) + 
...
# Get mean and standard deviation
eda <- do.call(data.frame, aggregate(evenness ~ hospital, even, function(x) c(mean = mean(x), sd = sd(x))))
...
# Plot
p <- ggboxplot(even, x = "hospital", y = "evenness", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#FEF250")) + 
