...
resfinder_PHY_rel_uniq_temp <- subset_samples(resfinder_PHY_rel_uniq, (hospital == "SLMC" | hospital == "UST"))
resfinder_PHY_rel_uniq_temp %>%
  dist_calc("aitchison") %>%
...
```{r}
# Test the significance 
resfinder_PHY_rel_uniq_temp <- subset_samples(resfinder_PHY_rel_uniq, (hospital == "SLMC" | hospital == "CGH"))
resfinder_PHY_rel_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
```
...
```{r}
# Test the significance 
resfinder_PHY_rel_uniq_temp <- subset_samples(resfinder_PHY_rel_uniq, (hospital == "CGH" | hospital == "UST"))
resfinder_PHY_rel_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
```
...
```{r}
# Test significance
metaphlan_PHY_rel_genus_uniq_temp <- subset_samples(metaphlan_PHY_rel_genus, (hospital == "SLMC" | hospital == "UST"))
metaphlan_PHY_rel_genus_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
```
...
```{r}
# Test significance
metaphlan_PHY_rel_genus_uniq_temp <- subset_samples(metaphlan_PHY_rel_genus, (hospital == "SLMC" | hospital == "CGH"))
metaphlan_PHY_rel_genus_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
```
...
```{r}
# Test significance
metaphlan_PHY_rel_genus_uniq_temp <- subset_samples(metaphlan_PHY_rel_genus, (hospital == "CGH" | hospital == "UST"))
metaphlan_PHY_rel_genus_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
```
...
```{r}
MGE_PHY_rel_uniq_temp <- subset_samples(MGE_PHY_rel_uniq, (hospital == "SLMC" | hospital == "UST"))
MGE_PHY_rel_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
```

```{r}
MGE_PHY_rel_uniq_temp <- subset_samples(MGE_PHY_rel_uniq, (hospital == "SLMC" | hospital == "CGH"))
MGE_PHY_rel_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
```
...
```{r}
MGE_PHY_rel_uniq_temp <- subset_samples(MGE_PHY_rel_uniq, (hospital == "CGH" | hospital == "UST"))
MGE_PHY_rel_uniq_temp %>%
  dist_calc("aitchison") %>%
  dist_permanova(variables = c("hospital"), n_perms = 9999, seed = 12345)
...
# Plot
p <- ggboxplot(arg_shannon_div, x = "hospital", y = "shannon", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) + 
  div_th +
  labs(title = "Diversity Metrics for ARGs Across Hospitals", 
...
# Plot
p <- ggbarplot(arg_shannon_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
...
# Plot
p <- ggboxplot(arg_simpson_div, x = "hospital", y = "simpson", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) + 
  div_th +
  labs(title = "Diversity Metrics for ARGs Across Hospitals", 
...
# Plot
p <- ggbarplot(arg_simpson_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) + 
  div_th +
  labs(title = "Diversity Metrics for ARGs Across Hospitals", 
                subtitle = "Simpson Diversity Index by Hospital",
...
# Plot
p <- ggbarplot(arg_rich_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  stat_pvalue_manual(pvalues, size = 6, y.position = 800, step.increase = 0.05, label = "p.adj") +
  div_th +
  labs(title = "Richness for ARGs Across Hospitals", 
...
p <- ggboxplot(arg_even, x = "hospital", y = "evenness", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) +
  div_th +
  labs(title = "Evenness for ARGs Across Hospitals", 
...
# Plot
p <- ggbarplot(arg_even_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Evenness for ARGs Across Hospitals", 
...
# Plot
p <- ggboxplot(tax_shannon_div, x = "hospital", y = "shannon", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) + 
  div_th +
  labs(title = "Diversity Metrics for Taxonomic Composition Across Hospitals", 
                subtitle = "Shannon Diversity Index by Hospital") +
...
# Plot
p <- ggbarplot(tax_shannon_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Diversity Metrics for Taxonomic Composition Across Hospitals", 
                subtitle = "Shannon Diversity Index by Hospital",
...
# Plot
p <- ggboxplot(tax_simpson_div, x = "hospital", y = "simpson", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) + 
  div_th +
  labs(title = "Diversity Metrics for Taxonomic Composition Across Hospitals", 
                subtitle = "Simpson Diversity Index by Hospital") +
...
# Plot
p <- ggbarplot(tax_simpson_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Diversity Metrics for Taxonomic Composition Across Hospitals", 
                subtitle = "Simpson Diversity Index by Hospital",
...
# Plot
p <- ggboxplot(tax_rich, x = "hospital", y = "richness", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) +
  div_th +
  labs(title = "Richness for Taxonomic Composition Across Hospitals", 
...
# Plot
p <- ggbarplot(tax_rich_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Richness for Taxonomic Composition Across Hospitals", 
                subtitle = "Richness Index by Hospital",
...
# Plot
p <- ggboxplot(tax_even, x = "hospital", y = "evenness", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) +
  div_th +
  labs(title = "Evenness for Taxonomic Composition Across Hospitals", 
                subtitle = "Pielou's Evenness by Hospital") +
...
# Plot
p <- ggbarplot(tax_even_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Evenness for Taxonomic Composition Across Hospitals", 
                subtitle = "Pielou's Evenness by Hospital",
...
# Plot
p <- ggboxplot(mge_shannon_div, x = "hospital", y = "shannon", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) +
  div_th +
  labs(title = "Diversity Metrics for MGEs Across Hospitals", 
                subtitle = "Shannon Diversity Index by Hospital") +
...
# Plot
p <- ggbarplot(mge_shannon_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Diversity Metrics for MGEs Across Hospitals", 
                subtitle = "Shannon Diversity Index by Hospital",
...
# Plot
p <- ggboxplot(mge_simpson_div, x = "hospital", y = "simpson", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) +
  div_th +
  labs(title = "Diversity Metrics for MGEs Across Hospitals", 
                subtitle = "Simpson Diversity Index by Hospital") +
...
# Plot
p <- ggbarplot(mge_simpson_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Diversity Metrics for MGEs Across Hospitals", 
                subtitle = "Simpson Diversity Index by Hospital",
...
p <- ggboxplot(mge_rich, x = "hospital", y = "richness", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) + 
  ...
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill = hospital)) + 
  div_th +
  labs(title = "Richness for MGEs Across Hospitals", 
                subtitle = "Richness by Hospital") +
...
# Plot
p <- ggbarplot(mge_rich_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  stat_pvalue_manual(pvalues, size = 6, y.position = 900, step.increase = 0.05, label = "p.adj") +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Richness for MGEs Across Hospitals", 
...
# Plot
p <- ggboxplot(mge_even, x = "hospital", y = "evenness", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize = 0.4, aes(fill=hospital)) + 
  div_th +
  labs(title = "Evenness for MGEs Across Hospitals", 
                subtitle = "Pielou's Evenness by Hospital") +
...
# Plot
p <- ggbarplot(mge_even_eda, x = "hospital", y = "mean", fill = "hospital", palette = c("#CD3857", "#61A6E3", "#CC7722")) +
  geom_errorbar(aes(ymin = conf.low, ymax = conf.high), width = 0.2) +
  div_th +
  labs(title = "Evenness for MGEs Across Hospitals", 
                subtitle = "Pielou's Evenness by Hospital",
...
```{r}
# Test multiple pairwise
stat.test <- pairwise.wilcox.test(df$RA, df$hospital, p.adjust.method = "BH")
stat.test
