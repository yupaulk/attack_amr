...
shannon_div$hospital <- resfinder_PHY_counts_HWW@sam_data$hospital
...
# Save plot
ggsave(filename = "plot5_shannon.tiff",
       width = 16, height = 13, dpi = 300, units = "in", device='tiff', scale = 1)
```
...
simpson_div$hospital <- resfinder_PHY_counts_HWW@sam_data$hospital
...
# Save plot
ggsave(filename = "plot5_simpson.tiff",
       width = 16, height = 13, dpi = 300, units = "in", device='tiff', scale = 1)
```
...
colnames(div) <- c("invsimpson", "observed", "hospital")
...
rich$hospital <- resfinder_PHY_counts_HWW@sam_data$hospital
...
p1 <- p1 + labs(title = "Richness for ARGs Across Hospitals", 
                ...
                scale_y_continuous(limits = c(350,max(rich$richness)), breaks = seq(350,max(rich$richness), by = 50))
...
# Save plot
ggsave(filename = "plot5_richness.tiff",
       width = 16, height = 13, dpi = 300, units = "in", device='tiff', scale = 1)
```
...
even$hospital <- resfinder_PHY_counts_HWW@sam_data$hospital
...
# Save plot
ggsave(filename = "plot5_evenness.tiff",
       width = 16, height = 13, dpi = 300, units = "in", device='tiff', scale = 1)
```
